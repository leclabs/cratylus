...
| **property 1 is breached, and a GATE PINS THE BREACH**                                         | `src/hooks/memory-consolidation-nudge.ts:1` — a canon **cell** — imports `RUNTIME_BIN` from `@cratylus/runtime`, and `test/bin-name-single-home.test.ts:57,101` asserts it stays                                                                                                                                                                                                          |
