...
Event ≜ the harness-agnostic lifecycle vocabulary ⟨corpus-owned ⟨a name for a moment ∴ signification⟩ ; shape ⊥ vocabulary : shape @ schema · names @ corpus ; the PIVOT every adapter maps from⟩
