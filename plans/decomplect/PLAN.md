...
| ----- | ------ | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0** | 8      | 8            | `memory-nudge-is-flaky-under-the-full-verify` · `memory-test-hermetic-sentinel-has-six-homes` · `project-never-cleans-its-out-dir` · `structural-parsimony-belongs-to-canon` · `t-accept-fifth-kind` · `t-coined-classification` · `t-projection-file-anchor` · `t-rule-cell-body` |
| **1** | 7      | 6            | `deployed-drifts-from-rendered-unwatched` · `t-canon-soul` · `t-classification-wears-three-signs` · ~~t-engine-internal-names-await-decode~~ · `t-harness-adapter-surface-is-genus-and-species` · `t-kind-is-triple-booked` · `t-lifecycle-vocabulary`                             |
| **2** | 2      | 2            | `elevate-installs-no-mechanism` · `t-tool-class-vocabulary`                                                                                                                                                                                                                        |
