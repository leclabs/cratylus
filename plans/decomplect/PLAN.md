...
| ----- | ------ | ------------ | --------------------------------------------------------------------------------------- |
| **0** | 2      | 2            | `namespaced-pairs-are-a-hand-rolled-map` · `source-can-go-invisible-to-every-text-tool` |
...
- `deploy-surface` (8) — `t-kind-root-ignores-agent-ext` · `t-init-hardcodes-harness-dir` · `deployed-drifts-from-rendered-unwatched` · `t-signify-marker` · `t-engine-internal-names-await-decode` · `namespaced-pairs-are-a-hand-rolled-map` · `source-can-go-invisible-to-every-text-tool` · `drift-is-checkable-but-nothing-checks-it`
