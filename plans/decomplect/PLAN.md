...
| ----- | ------ | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **0** | 5      | 5            | `t-capture-row` · `t-config-dotfile-was-shipped-underived` · `t-manifest-file-basename` · `t-signify-marker` · `t-soul-to-target-in-forge`                                                                                                                                                                                                                                                                                                                                                              |
| **1** | 16     | 16           | `project-never-cleans-its-out-dir` · `t-accept-fifth-kind` · `t-anatomy-root-compose` · `t-authoring-surface` · `t-canon-package-default` · `t-ground-numbers-are-unmeasured` · `t-init-hardcodes-harness-dir` · `t-kind-root-ignores-agent-ext` · `t-memory-config-scope-is-incoherent` · `t-policy-seam-unused` · `t-project-human-vs-engine` · `t-seed-prose-has-drifted` · `t-shim-path-from-capability` · `t-substrate-concept` · `t-tap-anchor` · `the-host-install-is-a-symlink-nobody-authored` |
| **2** | 6      | 6            | `deployed-drifts-from-rendered-unwatched` · `memory-nudge-is-flaky-under-the-full-verify` · `retire-relocates-but-the-operator-deletes` · `t-coined-classification` · `t-projection-file-anchor` · `t-worker-payload-seam-and-property-1`                                                                                                                                                                                                                                                               |
| **3** | 6      | 6            | `bin-name-gate-stops-at-the-language-boundary` · `t-canon-soul` · `t-classification-wears-three-signs` · `t-definiens-vs-residue` · `t-harness-adapter-surface-is-genus-and-species` · `t-lifecycle-vocabulary`                                                                                                                                                                                                                                                                                         |
| **4** | 4      | 4            | `elevate-installs-no-mechanism` · `t-kind-is-triple-booked` · `t-rule-cell-body` · `t-tool-class-vocabulary`                                                                                                                                                                                                                                                                                                                                                                                            |

**Slices** — a partition, 8 of them, cut to minimize cross-slice edges in `R`:

- `corpus-rename` (4) — `t-manifest-file-basename` · `t-canon-package-default` · `project-never-cleans-its-out-dir` · `t-ground-numbers-are-unmeasured`
- `plan-machinery` (4) — `t-anatomy-root-compose` · `retire-relocates-but-the-operator-deletes` · `t-coined-classification` · `elevate-installs-no-mechanism`
...
- `deploy-surface` (4) — `t-kind-root-ignores-agent-ext` · `t-init-hardcodes-harness-dir` · `deployed-drifts-from-rendered-unwatched` · `t-signify-marker`
- `host-and-config` (5) — `t-policy-seam-unused` · `t-config-dotfile-was-shipped-underived` · `the-host-install-is-a-symlink-nobody-authored` · `memory-nudge-is-flaky-under-the-full-verify` · `t-memory-config-scope-is-incoherent`
