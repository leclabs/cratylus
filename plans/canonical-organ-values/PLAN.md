...
| `T6 rename-carry-on`      | ready   | `weitermachen.md → carry-on.md`; H1 carry-on; keep weitermachen as trigger word            |
| `T7 layman-builder-skill` | ready   | New skill: agent-reader, layman Q&A per organ, default = first option                      |
