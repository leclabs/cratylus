# run-the-business — charter

**What this is.** The perpetual plan: the live backlog + standalone tasks that don't warrant their own
...
symbols); a cell edit passes CE ∧ ME; a deploy is verified by on-host content (sha256 vs the render
tree), never the exit message.
