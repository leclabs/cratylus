...
_This file is the human projection of `dimensions/autonomy/` — generated by `project-human` from the dimension’s canonical semantics (enum set value-catalog). Edit the `.ts` value cells and regenerate; do not hand-edit._
