...
// `name / trigger / description / verb / body`. It DIVERGES on two axes,
 ...
 * one-line bound; `body` is the skill's PRIMARY σ* payload (its content
...
export type SkillExpression = string & {
  readonly __tag: 'skill-expression';
};
