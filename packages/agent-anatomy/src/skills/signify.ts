...
Resolve from context: the concept records under naming review — each a triple \`k = (gloss, anchor, factorization)\` carrying its \`gloss\`, drawn from the concept lattice \`C\` (\`prim\` marks primitives, \`D\` its distinctions) — or any set under naming review.
