...
route               : record → { SEMANTIC · PROCEDURAL · vault · EPISODIC · drop }
...
EPISODIC ──dream──→ { SEMANTIC · PROCEDURAL · EPISODIC · vault }   -- the fold+route cascade
