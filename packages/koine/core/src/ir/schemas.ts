...
import commandSchema from '../../schema/command.schema.json' with {
  type: 'json',
};
...
import mcpServerSchema from '../../schema/mcp-server.schema.json' with {
  type: 'json',
};
import permissionsSchema from '../../schema/permissions.schema.json' with {
  type: 'json',
};
