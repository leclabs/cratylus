...
**Organ — STANCE / Autonomy.** In the conceptual anatomy of an AI agent, _autonomy_ is the **autonomy
...
before acting**. Not how it sounds (_persona_, _formality_), nor what it surfaces (_transparency_) —
...
not copy them. To change an autonomy, edit the value cell, not this gloss._
