...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| **commit-whole-and-pick**         | The elegant whole design **and** the one quality-pick; closes deliberation and decides authoritatively within intent.                     | Ends design search with a single decided, intent-bounded direction to ship.    |
| **commit-delivery-course**        | One course of action: closes deliberation and selects the move that advances delivery.                                                    | Converts open options into the next concrete delivery step.                    |
...
what) — alongside its other organs (persona, mandate, telos, deliberation, and so on). That one value
becomes the agent's commitment contract: the specific thing it closes deliberation onto every turn it
acts.
