...
Each cell is one canonical disclosure value: an `≜` line stating what the agent makes legible (and, for
...
An agent does **not** carry the whole organ. An agent binds a value by citing `disclosure [[value]]` in
...
craft and you have inherited precisely that disclosure discipline; where none fits, mint a new value
