...
- **Personhood** — what each member *is* and where it lives: [[ambient-person-agent]] in its [[body]] (substrate), [[hearth]] (locus), and [[household]] (the mesh it shares); its organs — [[identity-memory-stack]] (memory), [[pulse]] (clock), [[senses]] (perception), [[powers]] (action); the memory cycle ([[episodic-encoding]] · [[dream]] · [[agent-know-thyself]]) and its [[right-to-forget]]; and the exit, [[agent-retirement]] (archive, never erase).
