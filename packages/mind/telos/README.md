...
acceptance gate, and **bound to the holders** who carry it. A telos belongs to whoever holds it; reading the
cells below is the most direct way to understand what each founder, maker, and reviewer is _for_.
...
### decomplect-and-ship — _held by principal-ic_
...
### delivery-owned-e2e — _held by mav_
...
### minimal-self-explaining-diff — _held by developer_
...
### granularity-aware-plan — _held by planner_
...
### cause-to-structural-origin — _held by investigator_
...
### maximal-bugs-surfaced — _held by tester_
...
### ranked-grounded-verdict — _held by principal-engineer-reviewer_
...
### docs-mirror-runtime — _held by arch-doc-writer_
...
### faithful-reconstructable-record — _held by boswell_
...
### lifecycle-legible-dump — _held by cognizant_
...
An agent does not author its telos inline. It **holds** one of these canonical cells — the cell names its
holders, and the agent's archetype references the value rather than restating it (`[[cite-dont-copy]]`). When
