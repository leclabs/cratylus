...
{praxis, carry-on} (both legitimately compose NO sibling skill) -- no OTHER
...
COMPOSE_NOTHING_ALLOWLIST = {"praxis", "carry-on"}
...
def main() -> int:
    ...
    # are the known compose-nothing allowlist {praxis, carry-on}. Any OTHER
