...
// `AGENTS.md` (repo-scoped AMBIENT context, loaded per-session ON ENTRY): that carry
// dies the moment an artifact deploys OUTSIDE this workspace (a foreign repo, a blank
