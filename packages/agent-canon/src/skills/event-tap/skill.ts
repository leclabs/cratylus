...
uninstall        ≜ \`scripts/eventTap.mjs uninstall\` ∴ ¬ attached(target)
...
uninstall ∘ install ⊨ target ≡ target₀ ∧ foreign preserved ⟨zero residue⟩
e ∈ E ∧ e ∉ lifecycle ⇒ ⊥ ⟨loud⟩
verb ∉ { install · uninstall · read · status } ⇒ ⊥ ⟨loud⟩
E = ∅ ⇒ ¬ attached(target)
...
install ⊨ uninstall owed ⟨an uninstalled tap outlives the question it was installed to answer⟩` as SkillExpression;
