...
gate            ∈ { schema, references, fences, symbols, verbatim-ref-free, operative, provenance }
...
create-skill ≜ name-as-verb → write fm → H1 + formula ( + Bindings ⇔ composes-siblings ) → author block @ formalize → resolve → verify( ∀ gate : PASS ) → iterate-until-green → deploy
