...
// dispatches against.
//
// The runtime dispatcher (`@leclabs/agent-runtime`) treats a capability port as an
...
import type { MemoryStrategy } from '@leclabs/agent-runtime';
import type { VerbArgs } from '@leclabs/agent-runtime/dispatch';
