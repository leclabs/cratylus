// ─────────────────────────────────────────────────────────────────────────────
// The memory capability, as a runtime strategy — agent-memory's implementation
// of the `MemoryStrategy` PORT (`@leclabs/agent-runtime`). This is the REHOUSING
...
/**
 * The agent-memory {@link MemoryStrategy} implementation, bound to one home.
