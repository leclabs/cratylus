...
//
// The agent-canon corpus emits a single canonical agent-forge IR (agent-canon/toolkit/emit_ir.py;
// the committed `agent-canon.agent-forge.json` fixture below is its output: 11 agents +
...
//
// The fixture is regenerated by `cd packages/agent-canon && python3 toolkit/emit_ir.py
// <path> --target claude --target codex`. agent-canon/toolkit/test_ir_bridge.py owns
...
const fixture = JSON.parse(
  readFileSync(join(__dirname, 'agent-canon.agent-forge.json'), 'utf8'),
) as { agents: Agent[]; skills: Skill[] };

// The IR under test: agent-canon's emitted agents + skills. (manifest.overrides
...
// agent-canon fixture — every agent carries `color` — is not a zero-loss
